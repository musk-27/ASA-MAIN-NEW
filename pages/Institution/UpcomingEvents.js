...
const UpcomingEvents = () => {
  return (
    <div><div class="p-4 mt-4">
    <h1 class="text-4xl text-center font-semibold mb-6 font-akira">UPCOMING EVENTS</h1>
    <div class="">
      <div class="flex flex-col md:grid grid-cols-12 text-gray-50">
        ...
        <div class="flex md:contents">
          <div class="col-start-2 col-end-4 mr-10 md:mx-auto relative">
            ...
            <div class="w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-red-600 shadow text-center">
              <i class="fas fa-times-circle text-blue-600"></i>
            </div>
          </div>
          <div class="bg-red-600 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 class="font-semibold text-lg mb-1 text-green-600">
              Cancelled
            </h3>
        ...
        <div class="flex md:contents">
          <div class="col-start-2 col-end-4 mr-10 md:mx-auto relative">
            ...
            <div class="w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-red-300 shadow text-center">
              <i class="fas fa-exclamation-circle text-red-400"></i>
            </div>
          </div>
          <div class="bg-blue-300 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
            <h3 class="font-semibold text-lg mb-1 text-red-400">
              Delivered
            </h3>
