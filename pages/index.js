  ...
  return (
    <>
      <Layout seo={seo}>
        ...
        <div className="w-screen bg-black lg:py-20">
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-base text-gray-200 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      ...
                      excellence, teamwork, and leadership. Our expert coaches
                      are committed to developing young athletes, preparing them
                      not just for sports but for life. Whether on the field,
                      court, or track, we provide the resources and guidance to
                      help every student athlete reach their full potential.
                    </p>
                  </div>
        ...
        <div class="py-10 px-4 dark:bg-gray-900 lg:px-20 lg:py-20">
          <div class="">
            <div class=" mx-auto">
              <div class="flex flex-wrap items-center pb-12">
                <div class="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                  <div class="text-color">
                    ...
                    <p
                      role="contentinfo"
                      class="text-md dark:text-white lg:text-2xl lg:leading-7 md:leading-6 f-f-r py-4 md:py-8 text-justify font-montserrat"
                    >
                      At Arya Global School, we believe that sports play a
                      crucial role in shaping a child's growth and development.
                      Our sports programs are designed to help students explore
                      their passion for sports while promoting physical fitness,
                      teamwork, and discipline. From basketball to athletics,
                      our school offers a range of sports activities that cater
                      to every student, whether they're looking to compete or
                      simply stay active. Our dedicated coaches provide
                      personalized training to each student, fostering not only
                      athletic skills but also life skills like perseverance and
                      leadership.
                    </p>
                  </div>
                </div>
                <div class="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
                  ...
                  <div class="relative z-10 bg-white rounded shadow p-6 w-10/12 -mb-20">
                    <div class="flex items-center justify-between w-full sm:w-full mb-4">
                      <h2 class="xl:text-lg text-sm font-akira  font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-red-600">
