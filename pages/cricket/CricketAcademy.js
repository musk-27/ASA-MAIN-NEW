  ...
  return (
    <div className="relative">
      <div
        ...
        style={{
          backgroundImage: 'url("/assets/Cricket/CricketAcademy.jpg")',
      ...
      <div className="relative bg-black bg-opacity-80 py-20 p-4 z-10">
        <div className="max-w-5xl mx-auto text-center lg:py-20">
          <div className="w-full max-w-3xl mx-auto bg-black bg-opacity-60 lg:rounded-full md:rounded-full py-10">
            <h1
              className="text-xl lg:text-4xl font-bold mt-2 font-akira mb-6 uppercase text-transparent transition-all duration-200 transform font-akira bg-gradient-to-tr from-yellow-300 to-red-500 bg-clip-text"
            ...
            >
              <button
                ...
                className="inline-block py-4 px-8 leading-none text-white font-akira bg-slate-800 hover:bg-gradient-to-tr from-yellow-300 to-red-500 rounded shadow-lg text-xl font-bold transition-colors duration-300 transform hover:scale-105"
              >
                Enrol Now
              </button>
            </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 z-50 bg-black bg-opacity-75">
            <div className="bg-white rounded-lg p-6 shadow-lg max-w-md mx-auto w-full relative">
              ...
              <p className="mb-4 font-bold text-sm font-akira text-center">
                Enrol Now to start your Academy
              </p>
