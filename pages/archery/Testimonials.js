...
//       <h2 className="font-akira text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gradientYellow to-gradientOrange text-center mb-6">
//         Testimonials
//       </h2>
...
//           <FaChevronLeft />
//         </button>
//         <div className="p-6 bg-white rounded-lg shadow-md transition-transform transform">
//           <p className="italic text-black text-center">"{testimonials[currentIndex].quote}"</p>
//           <p className="mt-4 font-bold text-black text-center">{testimonials[currentIndex].name}</p>
